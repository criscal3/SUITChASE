...
const TA_SECONDS = 10;       // Ta: tiempo del algoritmo en segundos (máx. espera inicial: 90 s)
...
export const INITIAL_WAIT_SECONDS = 90;    // Espera inicial real antes de iniciar el cronómetro
